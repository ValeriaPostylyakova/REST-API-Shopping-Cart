...
import com.deilycodework.dream_shop.exception.ImageNotFoundException;
import com.deilycodework.dream_shop.model.Image;
import com.deilycodework.dream_shop.response.ApiResponse;
import com.deilycodework.dream_shop.service.image.IImageService;
...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<ApiResponse> saveImages(@RequestPart("files") List<MultipartFile> files,  @RequestParam Long productId) {
       try {
    ...
    public ResponseEntity<Resource> downloadImage(@PathVariable Long id) throws SQLException {
        ...
        byte[] data = imageService.getImageBytesById(id);
    ...
    public ResponseEntity<ApiResponse> updateImage(@PathVariable Long id, MultipartFile file) {
        try {
            Image image = imageService.getImageById(id);
